...
*Draft — June 2026 · Apache-2.0 libraries, **now published**: the `sk_pqc` hybrid KEM ships across Python, Dart, and Rust — `pip install sk-pqc` · `dart pub add sk_pqc` · `cargo add sk-pqc` (repos [sk-pqc-py](https://github.com/smilinTux/sk-pqc-py) · [sk-pqc-dart](https://github.com/smilinTux/sk-pqc-dart) · [sk-pqc-rs](https://github.com/smilinTux/sk-pqc-rs)) — and `sk_pgp` (Python OpenPGP-PQC) at [github.com/smilinTux/sk_pgp](https://github.com/smilinTux/sk_pgp) · live at [skpqc.skworld.io](https://skpqc.skworld.io)*
...
**Libraries** — `sk_pqc` (hybrid KEM, one wire format across Python/Dart/Rust), Apache-2.0, **published**: `pip install sk-pqc` ([sk-pqc-py](https://github.com/smilinTux/sk-pqc-py)) · `dart pub add sk_pqc` ([sk-pqc-dart](https://github.com/smilinTux/sk-pqc-dart)) · `cargo add sk-pqc` ([sk-pqc-rs](https://github.com/smilinTux/sk-pqc-rs)) · live at [skpqc.skworld.io](https://skpqc.skworld.io); `sk_pgp` (Python OpenPGP-PQC engine, PyO3→Sequoia), Apache-2.0, [github.com/smilinTux/sk_pgp](https://github.com/smilinTux/sk_pgp).
